        ...
        children: [
          ...
          child: Container(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical: isScreenSmall?screenSize.height*0.05:screenSize.height*0.1, horizontal: screenSize.width*0.1),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                  mainAxisAlignment: isScreenSmall?MainAxisAlignment.start:MainAxisAlignment.center,
                  children: [
                    // Center(
                    //   child: InkWell(
                    //     child: Text(
              ...
              Container(
                  child: ImageCarousal(),
                height: isScreenSmall?screenSize.height*0.3:screenSize.height*0.7,
              ),
                ...
                children: [
                  InkWell(
                    ...
                    child: Card(
                      ...
                      shadowColor: themeChange.darkTheme?Colors.blue:Colors.orange,
                      child: Column(
                        children: [
                          SizedBox(

                            child: Image.asset('rotary_pres.jpg',
                              height: screenSize.height*0.3,
                              width: screenSize.width*0.7,
                            ),
                          ),
                          Container(
                            color: themeChange.darkTheme?Colors.blue:Colors.orange,
                            width: screenSize.width*0.7,
                            height: screenSize.height*0.08,
                            child: Center(
                              child: Text(
                                ...
                                style: GoogleFonts.monda(
                                  fontSize: 22.0,
                                    color: themeChange.darkTheme?Colors.white:Colors.grey[900]
                                ),
                              ),
                            ),
                          ),
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical: screenSize.height*0.05, horizontal: screenSize.width*0.1),
                child: Column(
                  //column for 'About Us'
