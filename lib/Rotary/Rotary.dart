            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Center(
                    child: Padding(
                      padding: EdgeInsets.symmetric(vertical: screenSize.height*0.01, horizontal: isScreenSmall?16:screenSize.width*0.2),
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FlatButton(
                              onPressed: () {
                                _launchURL('https://www.instagram.com/p/CCymeL_gJEv/');
                              },
                              child: Text(
                          ...
                          SizedBox(height: 50.0),
                          Text("Rotary Bangalore South East (RBSE) is a club under the umbrella of Rotary International, a non-profit organization. Rotary International is perhaps the largest collection of organized volunteers in the world. Rotary International is divided into districts, which are then sub-divided into clubs.\nRBSE was chartered in the year 2000 as a Rotary club, a mark to begin the millennium. The club today, has 30 members and over the years executed thousands of non-profit projects along with its various youth wings.\nCurrently, the youth wings under RBSE are:"
                              ,
                              style: GoogleFonts.poppins(
                                  // fontFamily: 'Bahnschrift',
                                  //sans can also be tried
                          ...
                          SizedBox(height: 10,),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: isScreenSmall?16:screenSize.width*0.04),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                          ...
                          SizedBox(height: 10,),
                          Text("We at RBSE, have been instrumental in many signature projects along with our enthusiastic youth wings. Some of them are:-"
                              ,
                              style: GoogleFonts.poppins(
                                  // fontFamily: 'Bahnschrift',
                                  //sans can also be tried
                          ...
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: isScreenSmall?16:screenSize.width*0.04, vertical: 10),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                InkWell(
